...
public class AssistantActivity extends Activity implements Button.OnButtonEventListener {
    ...
    private static final String DEVICE_MODEL_ID = "test-android-things-ciandt";
    private static final String DEVICE_INSTANCE_ID = "test-android-things-ciandt";
    private static final String LANGUAGE_CODE = "en-US";

    // Hardware peripherals.
    private Button mButton;
    private android.widget.Button mButtonWidget;
    private android.widget.Button mButtonCloseApp;
    private Gpio mLed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "Starting Android Things - Analytics Chatbot demo");

        setContentView(R.layout.activity_main);
        mButtonCloseApp = findViewById(R.id.closeBtn);
        mButtonCloseApp.setOnClickListener(new OnClickListener() {
        ...
        //if (USE_VOICEHAT_I2S_DAC) {
            audioInputDevice = findAudioDevice(AudioManager.GET_DEVICES_INPUTS, AudioDeviceInfo.TYPE_USB_HEADSET);
            if (audioInputDevice == null) {
                Log.e(TAG, "failed to find I2S audio input device, using default");
            }
            audioOutputDevice = findAudioDevice(AudioManager.GET_DEVICES_OUTPUTS, AudioDeviceInfo.TYPE_USB_HEADSET);
        ...
        mEmbeddedAssistant = new EmbeddedAssistant.Builder()
                ...
                .setConversationCallback(new ConversationCallback() {
                    ...
                    public void onResponseStarted() {
                        ...
                        // When bus type is switched,
                        // the AudioManager needs to reset the stream volume
                        if (mDac != null) {
                            try {
